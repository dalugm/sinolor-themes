...
;;;; cider
    ...
    `(cider-warning-highlight-face ((,c :inherit sinolor-themes-underline-warning)))
...
;;;; consult
    ...
    `(consult-key ((,c :inherit sinolor-themes-key-binding)))
...
;;;; dired
    ...
    `(dired-flagged ((,c :inherit sinolor-themes-mark-delete)))
    `(dired-header ((,c :inherit bold)))
    `(dired-ignored ((,c :inherit shadow)))
    `(dired-mark ((,c :foreground ,fg-intense)))
    `(dired-marked ((,c :inherit sinolor-themes-mark-select)))
...
;;;; eglot
    ...
    `(eglot-diagnostic-tag-unnecessary-face ((,c :inherit sinolor-themes-underline-info)))
;;;; eldoc
...
;;;; embark
    `(embark-keybinding ((,c :inherit sinolor-themes-key-binding)))
    `(embark-keybinding-repeat ((,c :inherit bold)))
    `(embark-collect-marked ((,c :inherit sinolor-themes-mark-select)))
...
;;;; flycheck
    `(flycheck-error ((,c :inherit sinolor-themes-underline-error)))
    `(flycheck-fringe-error ((,c :inherit sinolor-themes-mark-delete)))
    `(flycheck-fringe-info ((,c :inherit sinolor-themes-mark-select)))
    `(flycheck-fringe-warning ((,c :inherit sinolor-themes-mark-other)))
    `(flycheck-info ((,c :inherit sinolor-themes-underline-info)))
    `(flycheck-warning ((,c :inherit sinolor-themes-underline-warning)))
;;;; flymake
    `(flymake-end-of-line-diagnostics-face ((,c :inherit italic :height 0.85 :box ,border)))
    `(flymake-error ((,c :inherit sinolor-themes-underline-error)))
    ...
    `(flymake-note ((,c :inherit sinolor-themes-underline-info)))
    ...
    `(flymake-warning ((,c :inherit sinolor-themes-underline-warning)))
...
;;;; flyspell
    `(flyspell-duplicate ((,c :inherit sinolor-themes-underline-warning)))
    `(flyspell-incorrect ((,c :inherit sinolor-themes-underline-error)))
;;;; font-lock
...
;;;; info
    `(Info-quoted ((,c :inherit sinolor-themes-fixed-pitch :foreground ,prose-verbatim))) ; the capitalization is canonical
    ...
    `(info-title-1 ((,c :inherit sinolor-themes-heading-1)))
    `(info-title-2 ((,c :inherit sinolor-themes-heading-2)))
    `(info-title-3 ((,c :inherit sinolor-themes-heading-3)))
    `(info-title-4 ((,c :inherit sinolor-themes-heading-4)))
...
;;;; jit-spell
    `(jit-spell-misspelling ((,c :inherit sinolor-themes-underline-error)))
;;;; jinx
    `(jinx-misspelled ((,c :inherit sinolor-themes-underline-warning)))
;;;; keycast
...
;;;; line numbers (display-line-numbers-mode and global variant)
    ...
    `(line-number ((,c :inherit (sinolor-themes-fixed-pitch shadow default))))
...
;;;; magit
    ...
    `(magit-header-line-key ((,c :inherit sinolor-themes-key-binding)))
...
;;;; marginalia
    ...
    `(marginalia-key ((,c :inherit sinolor-themes-key-binding)))
...
;;;; markdown-mode
    ...
    `(markdown-code-face ((,c :inherit sinolor-themes-fixed-pitch :background ,bg-inactive :extend t)))
    `(markdown-gfm-checkbox-face ((,c :foreground ,warning)))
    `(markdown-header-face (( )))
    `(markdown-header-face-1 ((,c :inherit sinolor-themes-heading-1)))
    `(markdown-header-face-2 ((,c :inherit sinolor-themes-heading-2)))
    `(markdown-header-face-3 ((,c :inherit sinolor-themes-heading-3)))
    `(markdown-header-face-4 ((,c :inherit sinolor-themes-heading-4)))
    `(markdown-header-face-5 ((,c :inherit sinolor-themes-heading-5)))
    `(markdown-header-face-6 ((,c :inherit sinolor-themes-heading-6)))
    `(markdown-highlighting-face ((,c :background ,bg-info :foreground ,info)))
    `(markdown-inline-code-face ((,c :inherit sinolor-themes-fixed-pitch :foreground ,prose-code)))
    `(markdown-italic-face ((,c :inherit italic)))
    `(markdown-language-keyword-face ((,c :inherit sinolor-themes-fixed-pitch :background ,bg-dim)))
    ...
    `(markdown-table-face ((,c :inherit sinolor-themes-fixed-pitch :foreground ,prose-table)))
...
;;;; mode-line
    `(mode-line ((,c :inherit sinolor-themes-ui-variable-pitch :background ,bg-mode-line :foreground ,fg-mode-line)))
    `(mode-line-active ((,c :inherit mode-line)))
    `(mode-line-buffer-id ((,c :inherit bold)))
    `(mode-line-emphasis ((,c :inherit bold :foreground ,modeline-info)))
    `(mode-line-highlight ((,c :inherit highlight)))
    `(mode-line-inactive ((,c :inherit sinolor-themes-ui-variable-pitch :background ,bg-alt :foreground ,fg-dim)))
;;;; mood-line
...
;;;; mu4e
    ...
    `(mu4e-highlight-face ((,c :inherit sinolor-themes-key-binding)))
...
;;;; notmuch
    ...
    `(notmuch-jump-key ((,c :inherit sinolor-themes-key-binding)))
...
;;;; org
    ...
    `(org-agenda-date ((,c ,@(sinolor-themes--heading 'agenda-date) :foreground ,date-weekday)))
    ...
    `(org-agenda-structure ((,c ,@(sinolor-themes--heading 'agenda-structure) :foreground ,fg-alt)))
    ...
    `(org-block ((,c :inherit sinolor-themes-fixed-pitch :background ,bg-inactive :extend t)))
    `(org-block-begin-line ((,c :inherit (shadow sinolor-themes-fixed-pitch) :background ,bg-dim :extend t)))
    `(org-block-end-line ((,c :inherit org-block-begin-line)))
    `(org-checkbox ((,c :foreground ,warning)))
    `(org-checkbox-statistics-done ((,c :inherit org-done)))
    `(org-checkbox-statistics-todo ((,c :inherit org-todo)))
    `(org-clock-overlay ((,c :background ,bg-hover-secondary)))
    `(org-code ((,c :inherit sinolor-themes-fixed-pitch :foreground ,prose-code)))
    `(org-column ((,c :inherit default :background ,bg-alt)))
    `(org-column-title ((,c :inherit (bold default) :underline t :background ,bg-alt)))
    `(org-date ((,c :inherit sinolor-themes-fixed-pitch :foreground ,date-common)))
    ...
    `(org-document-title ((,c :inherit sinolor-themes-heading-0)))
    `(org-done ((,c :foreground ,prose-done)))
    `(org-drawer ((,c :inherit sinolor-themes-fixed-pitch :foreground ,prose-metadata)))
    `(org-ellipsis (( ))) ; inherits from the heading's color
    `(org-footnote ((,c :inherit link)))
    `(org-formula ((,c :inherit sinolor-themes-fixed-pitch :foreground ,prose-table-formula)))
    ...
    `(org-level-1 ((,c :inherit sinolor-themes-heading-1)))
    `(org-level-2 ((,c :inherit sinolor-themes-heading-2)))
    `(org-level-3 ((,c :inherit sinolor-themes-heading-3)))
    `(org-level-4 ((,c :inherit sinolor-themes-heading-4)))
    `(org-level-5 ((,c :inherit sinolor-themes-heading-5)))
    `(org-level-6 ((,c :inherit sinolor-themes-heading-6)))
    `(org-level-7 ((,c :inherit sinolor-themes-heading-7)))
    `(org-level-8 ((,c :inherit sinolor-themes-heading-8)))
    `(org-link ((,c :inherit link)))
    `(org-list-dt ((,c :inherit bold)))
    `(org-macro ((,c :inherit sinolor-themes-fixed-pitch :foreground ,prose-macro)))
    `(org-meta-line ((,c :inherit sinolor-themes-fixed-pitch :foreground ,prose-metadata)))
    `(org-mode-line-clock (( )))
    `(org-mode-line-clock-overrun ((,c :inherit bold :foreground ,modeline-err)))
    `(org-priority ((,c :foreground ,prose-tag)))
    `(org-property-value ((,c :inherit sinolor-themes-fixed-pitch :foreground ,prose-metadata-value)))
    ...
    `(org-special-keyword ((,c :inherit (shadow sinolor-themes-fixed-pitch))))
    `(org-table ((,c :inherit sinolor-themes-fixed-pitch :foreground ,prose-table)))
    ...
    `(org-verbatim ((,c :inherit sinolor-themes-fixed-pitch :foreground ,prose-verbatim)))
...
;;;; org-modern
    `(org-modern-date-active ((,c :inherit (sinolor-themes-fixed-pitch org-modern-label) :background ,bg-alt)))
    `(org-modern-date-inactive ((,c :inherit (sinolor-themes-fixed-pitch org-modern-label) :background ,bg-dim :foreground ,fg-dim)))
    ...
    `(org-modern-time-active ((,c :inherit (sinolor-themes-fixed-pitch org-modern-label) :background ,bg-active :foreground ,fg-intense)))
...
;;;; outline-mode
    `(outline-1 ((,c :inherit sinolor-themes-heading-1)))
    `(outline-2 ((,c :inherit sinolor-themes-heading-2)))
    `(outline-3 ((,c :inherit sinolor-themes-heading-3)))
    `(outline-4 ((,c :inherit sinolor-themes-heading-4)))
    `(outline-5 ((,c :inherit sinolor-themes-heading-5)))
    `(outline-6 ((,c :inherit sinolor-themes-heading-6)))
    `(outline-7 ((,c :inherit sinolor-themes-heading-7)))
    `(outline-8 ((,c :inherit sinolor-themes-heading-8)))
;;;; outline-minor-faces
    `(outline-minor-0 (( )))
...
;;;; rst-mode
    `(rst-level-1 ((,c :inherit sinolor-themes-heading-1)))
    `(rst-level-2 ((,c :inherit sinolor-themes-heading-2)))
    `(rst-level-3 ((,c :inherit sinolor-themes-heading-3)))
    `(rst-level-4 ((,c :inherit sinolor-themes-heading-4)))
    `(rst-level-5 ((,c :inherit sinolor-themes-heading-5)))
    `(rst-level-6 ((,c :inherit sinolor-themes-heading-6)))
;;;; ruler-mode
...
;;;; shr
    `(shr-code ((,c :inherit sinolor-themes-fixed-pitch :foreground ,prose-code)))
    `(shr-h1 ((,c :inherit sinolor-themes-heading-1)))
    `(shr-h2 ((,c :inherit sinolor-themes-heading-2)))
    `(shr-h3 ((,c :inherit sinolor-themes-heading-3)))
    `(shr-h4 ((,c :inherit sinolor-themes-heading-4)))
    `(shr-h5 ((,c :inherit sinolor-themes-heading-5)))
    `(shr-h6 ((,c :inherit sinolor-themes-heading-6)))
...
;;;; tab-bar-mode
    `(tab-bar ((,c :inherit sinolor-themes-ui-variable-pitch :background ,bg-tab-bar)))
...
;;;; tab-line-mode
    `(tab-line ((,c :inherit sinolor-themes-ui-variable-pitch :background ,bg-tab-bar :height 0.95)))
...
;;;; transient
    ...
    `(transient-key ((,c :inherit sinolor-themes-key-binding)))
    `(transient-key-exit ((,c :inherit sinolor-themes-key-binding)))
    `(transient-key-noop ((,c :inherit (shadow sinolor-themes-key-binding))))
    `(transient-key-return ((,c :inherit sinolor-themes-key-binding)))
    `(transient-key-stay ((,c :inherit sinolor-themes-key-binding)))
...
;;;; trashed
    `(trashed-restored ((,c :inherit sinolor-themes-mark-other)))
;;;; tree-sitter
...
;;;; which-key
    ...
    `(which-key-key-face ((,c :inherit sinolor-themes-key-binding)))
...
;;;; writegood-mode
    `(writegood-duplicates-face ((,c :inherit sinolor-themes-underline-error)))
    `(writegood-passive-voice-face ((,c :inherit sinolor-themes-underline-info)))
    `(writegood-weasels-face ((,c :inherit sinolor-themes-underline-warning)))
;;;; woman
  ...
  "Face specs for use with `sinolor-themes-theme'.")

(defconst sinolor-themes-custom-variables
  '(
;;;; chart
...
;;;; flymake fringe indicators
    `(flymake-error-bitmap '(flymake-double-exclamation-mark sinolor-themes-mark-delete))
    `(flymake-warning-bitmap '(exclamation-mark sinolor-themes-mark-other))
    `(flymake-note-bitmap '(exclamation-mark sinolor-themes-mark-select))
;;;; ibuffer
    `(ibuffer-deletion-face 'sinolor-themes-mark-delete)
    `(ibuffer-filter-group-name-face 'bold)
    `(ibuffer-marked-face 'sinolor-themes-mark-select)
    `(ibuffer-title-face 'default))
  "Custom variables for `sinolor-themes-theme'.")

;;; Theme macros

;;;; Instantiate an Sinolor theme

;;;###autoload
(defmacro sinolor-themes-theme (name palette &optional overrides)
  "Bind NAME's color PALETTE around face specs and variables.
Face specifications are passed to `custom-theme-set-faces'.
While variables are handled by `custom-theme-set-variables'.
Those are stored in `sinolor-themes-faces' and
`sinolor-themes-custom-variables' respectively.
...
corresponding entries."
  ...
  (let ((sym (gensym))
    ...
    `(let* ((c '((class color) (min-colors 256)))
            (,sym (sinolor-themes--palette-value ',name ',overrides))
            ,@(mapcar (lambda (color)
                        (list color
                              `(sinolor-themes--retrieve-palette-value ',color ,sym)))
                      colors))
       (custom-theme-set-faces ',name ,@sinolor-themes-faces)
       (custom-theme-set-variables ',name ,@sinolor-themes-custom-variables))))

;;;; Use theme colors

(defmacro sinolor-themes-with-colors (&rest body)
  ...
  (let* ((sym (gensym))
         ...
         ;; inside a function.
         (colors (mapcar #'car (sinolor-themes--current-theme-palette))))
    `(let* ((c '((class color) (min-colors 256)))
            (,sym (sinolor-themes--current-theme-palette :overrides))
            ,@(mapcar (lambda (color)
                        (list color
                              `(sinolor-themes--retrieve-palette-value ',color ,sym)))
                      colors))
