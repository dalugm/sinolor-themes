;;; sinolor-green-theme.el --- inspired by green-is-the-new-black -*- lexical-binding: t; -*-
  ...
  ((bg           '("#141e1b" "#3a3a3a" "black"       ))
   ...
   (-modeline-pad
    (when sinolor-green-padded-modeline
      (if (integerp sinolor-green-padded-modeline)
          sinolor-green-padded-modeline
        4)))
...
;;;; extra faces
  ...
  (((line-number &override) :foreground base4)
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if sinolor-green-comment-bg
...
;;;; major-mode faces
   ...
   (magit-diff-hunk-heading
    :foreground bg
    :background (sinolor-themes--blend green bg 0.6)
    :extend t)
