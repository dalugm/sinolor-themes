;;; sinolor-light-theme.el --- Light theme -*- lexical-binding: t; -*-
  ...
  ((bg           '("#eef7f2" "#d7ffff" "brightwhite" ))
   ...
   (-modeline-pad
    (when sinolor-light-padded-modeline
      (if (integerp sinolor-light-padded-modeline)
          sinolor-light-padded-modeline
        4)))
   ...
   (modeline-bg-l
    (if -modeline-bright
      ...
      `(,(sinolor-themes--lighten (car bg-alt) 0.1)
        ,@(cdr base0))))
   (modeline-bg-inactive
    `(,(sinolor-themes--lighten (car bg-alt) 0.1) ,@(cdr bg-alt)))
...
;;;; extra faces
  ...
  (((line-number &override) :foreground fg-alt :background bg)
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if sinolor-light-comment-bg
...
;;;; major-mode faces
   ...
   (magit-diff-hunk-heading
    :foreground bg
    :background (sinolor-themes--blend blue bg 0.6)
    :extend t)
